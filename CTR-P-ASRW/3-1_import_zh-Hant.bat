...
COPY build\cxi0\exefs\banner\banner16\COMMON1.png build\cxi0\exefs\banner\banner0\COMMON1.png
COPY build\cxi0\exefs\banner\banner16\COMMON1.png build\cxi0\exefs\banner\banner14\COMMON1.png
